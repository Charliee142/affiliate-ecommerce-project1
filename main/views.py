...
def homepage(request):
	...
	vote_form = VoteForm()
	return render(request=request, template_name="main/home.html", context={'product':product, 'most_recent':most_recent, "new_posts":new_posts, "featured":featured, "vote_form":vote_form})	
